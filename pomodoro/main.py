...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer_label.config(text="Long Break", fg=PINK, bg=YELLOW)
    elif reps % 2 ==0:
        count_down(short_break_sec)
        timer_label.config(text="Short Break", fg=RED, bg=YELLOW)
    else:
...
def count_down(count):
    ...
    if count_sec < 10:
        count_sec = f"0{count_sec}"  #formating the timer
...
check_mark= Label(font=(FONT_NAME, 25), fg=GREEN, bg=YELLOW)
